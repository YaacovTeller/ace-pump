...
Private Sub SaveReport()
   Using csvOut As New System.IO.StreamWriter(OUTPUT_CSV_PATH)
       csvOut.WriteLine("Ace Well ID, Lease Name, Well Number, Orignal 'Well Name', API Number, Seneca Well ID")

       For Each well As SenecaWellInfo In SenecaWells
	   	   If well.Skip Then
		   	   csvOut.WriteLine(String.Format("0,No match,,{0},{1},{2}", well.SenecaWellName, well.ApiNumber, well.SenecaWellID))
		   Else
               csvOut.WriteLine(String.Format("{0},{1},{2},{3},{4},{5}", well.MatchedAceWell.AceWellID, well.MatchedAceWell.Lease.LeaseName, well.MatchedAceWell.WellNumber, well.SenecaWellName, well.ApiNumber, well.SenecaWellID))
		   End If
       Next
   End Using
End Sub
