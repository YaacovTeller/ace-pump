@ModelType AcePump.Web.Areas.Employees.Models.DisplayDtos.DeliveryTicketSignatureViewModel
    ...
    @If Model.LineItems.Any() Then
        @<table id="line-items-table">
            ...
            <tbody>
                ...
                <tr><td>&nbsp;</td><td>&nbsp;</td><td>Sales Tax @@ <strong>@Model.SalesTaxRate.ToString("p3")</strong></td><td><strong>@taxOwed.ToString("c")</strong></td></tr>
...
@<fieldset>
   ...
   <div class="existingSignature">
        ...
        <input type="button" value="Delete Signature" class="submit-area mobile-button" id="btnDeleteSignature"/>
   </div>
