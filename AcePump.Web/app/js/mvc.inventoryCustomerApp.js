...
(function () {
    ...
    angular
        ...
        .controller("InventoryCustomerController", InventoryCustomerController);

    InventoryCustomerController.$inject = ["$q", "$http", "kendo", "$scope"];
    function InventoryCustomerController($q, $http, kendo, $scope) {
