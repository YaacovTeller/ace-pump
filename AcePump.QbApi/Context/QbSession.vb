...
Namespace Context
    Public Class QbSession
        ...
        Private Sub CreateSession()
            ...
            _sessionManager.OpenConnection(appID, My.Application.Info.AssemblyName)
        ...
        Public Function TestConnection(fileName As String, ByRef responseMessage As String) As Boolean
            ClearMessagesetRequest()
